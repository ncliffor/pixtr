...
ActiveRecord::Schema.define(version: 20141009150816) do
  ...
  add_index "groupings", ["group_id", "image_id"], name: "index_groupings_on_group_id_and_image_id", unique: true, using: :btree
